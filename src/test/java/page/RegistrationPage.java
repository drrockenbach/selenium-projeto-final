...
public class RegistrationPage {
    ...
    private WebElement mensagemQtdMinimaTelefone;
    ...
    public void preencheDadosDeContato(String cellPhone, String domainName, String emailAdress) {
    ...
    public boolean mesagemObrigatoriedadeNomeApareceu() {
        return mensagemObrigatoriedadeNome.isDisplayed();
    }

    public boolean mensagemQtdMinimaTelefoneApareceu() {
        return mensagemQtdMinimaTelefone.isDisplayed();
    }
